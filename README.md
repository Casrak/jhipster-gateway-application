...
To build the final jar and optimize the jhipsterGatewayApplication application for production, run:
...
Then navigate to [http://localhost:9810](http://localhost:9810) in your browser.
